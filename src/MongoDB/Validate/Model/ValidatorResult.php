...
namespace Selen\MongoDB\Validate\Model;
...
class ValidatorResult
{
     ...
     * インスタンスを生成します
     *
     * @param \Selen\MongoDB\Validate\Model\ValidateResult ...$validateResults
     */
     ...
     * バリデーションの詳細情報を取得します
     *
     * @return \Selen\MongoDB\Validate\Model\ValidateResult[]
     */
