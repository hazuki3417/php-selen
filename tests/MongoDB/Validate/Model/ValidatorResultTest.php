...
namespace Tests\Selen\MongoDB\Validate\Model\ValidatorResult;
...
/**
 * @requires PHP >= 8.0
 * @coversDefaultClass \Selen\MongoDB\Validate\Model\ValidatorResult
 *
 * @group Selen
 * @group Selen/MongoDB
 * @group Selen/MongoDB/Validate
 * @group Selen/MongoDB/Validate/Model
 * @group Selen/MongoDB/Validate/Model/ValidatorResult
 *
 * @see \Selen\MongoDB\Validate\Model\ValidatorResult
 *
 * [command]
 * php ./vendor/bin/phpunit --group=Selen/MongoDB/Validate/Model/ValidatorResult
 *
 * @internal
 */
