...
class Radix5Test extends TestCase
{
    public function dataProviderVerify()
    {
        return [
            ...
            'pattern073' => ['expected' => true, 'input' => '01234'],

            'pattern074' => ['expected' => false, 'input' => '012345'],
            'pattern075' => ['expected' => false, 'input' => '01234a'],
            'pattern076' => ['expected' => false, 'input' => '01234A'],
        ];
    }
    ...
    {
        $this->assertEquals($expected, Radix5::verify($input));
    }
}
