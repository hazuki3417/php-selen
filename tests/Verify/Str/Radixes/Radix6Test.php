...
class Radix6Test extends TestCase
{
    public function dataProviderVerify()
    {
        return [
            ...
            'pattern073' => ['expected' => true, 'input' => '012345'],

            'pattern074' => ['expected' => false, 'input' => '0123456'],
            'pattern075' => ['expected' => false, 'input' => '012345a'],
            'pattern076' => ['expected' => false, 'input' => '012345A'],
        ];
    }
    ...
    {
        $this->assertEquals($expected, Radix6::verify($input));
    }
}
