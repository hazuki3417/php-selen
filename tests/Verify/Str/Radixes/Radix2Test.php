...
class Radix2Test extends TestCase
{
    public function dataProviderVerify()
    {
        return [
            ...
            // 2進数で使えない文字（数字）
            'pattern003' => ['expected' => false, 'input' => '2'],
            ...
            'pattern073' => ['expected' => true, 'input' => '01'],

            'pattern074' => ['expected' => false, 'input' => '012'],
            'pattern075' => ['expected' => false, 'input' => '01a'],
            'pattern076' => ['expected' => false, 'input' => '01A'],
        ];
    }
    ...
    {
        $this->assertEquals($expected, Radix2::verify($input));
    }
}
