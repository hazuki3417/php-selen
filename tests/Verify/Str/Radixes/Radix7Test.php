...
class Radix7Test extends TestCase
{
    public function dataProviderVerify()
    {
        return [
            ...
            'pattern073' => ['expected' => true, 'input' => '0123456'],

            'pattern074' => ['expected' => false, 'input' => '01234567'],
            'pattern075' => ['expected' => false, 'input' => '0123456a'],
            'pattern076' => ['expected' => false, 'input' => '0123456A'],
        ];
    }
    ...
    {
        $this->assertEquals($expected, Radix7::verify($input));
    }
}
