...
class Radix10Test extends TestCase
{
    public function dataProviderVerify()
    {
        return [
            ...
            'pattern073' => ['expected' => true, 'input' => '0123456789'],

            'pattern074' => ['expected' => false, 'input' => '0123456789A'],
            'pattern075' => ['expected' => false, 'input' => '0123456789a'],
        ];
    }
    ...
    {
        $this->assertEquals($expected, Radix10::verify($input));
    }
}
