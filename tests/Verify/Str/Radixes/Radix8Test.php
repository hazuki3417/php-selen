...
class Radix8Test extends TestCase
{
    public function dataProviderVerify()
    {
        return [
            ...
            'pattern073' => ['expected' => true, 'input' => '01234567'],

            'pattern074' => ['expected' => false, 'input' => '012345678'],
            'pattern075' => ['expected' => false, 'input' => '01234567a'],
            'pattern076' => ['expected' => false, 'input' => '01234567A'],
        ];
    }
    ...
    {
        $this->assertEquals($expected, Radix8::verify($input));
    }
}
