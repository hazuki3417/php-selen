...
class Radix9Test extends TestCase
{
    public function dataProviderVerify()
    {
        return [
            ...
            'pattern073' => ['expected' => true, 'input' => '012345678'],

            'pattern074' => ['expected' => false, 'input' => '0123456789'],
            'pattern075' => ['expected' => false, 'input' => '012345678a'],
            'pattern076' => ['expected' => false, 'input' => '012345678A'],
        ];
    }
    ...
    {
        $this->assertEquals($expected, Radix9::verify($input));
    }
}
